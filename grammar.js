...
class CFG {
  ...
  generateSentenceStructures(maxLen) {
...
// --------------------- example ---------------------
// let g = new CFG('S', {
//   'S':  new NonTerminal('S', [['NP', 'VP']]),
//   'NP': new NonTerminal('NP', [['PN'], 
//                           ['Det', 'N']]),
//   'VP': new NonTerminal('VP', [['Vintr'],
//                           ['Adv', 'VP']]),
//   'PN': new Terminal('PN'),
//   'Det': new Terminal('Det'),
//   'N':  new NonTerminal('N', [['Noun'], 
//                           ['Adj', 'N']]),
//   'Vintr': new Terminal('Vintr'),
//   'Adv': new Terminal('Adv'),
//   'Adj': new Terminal('Adj'),
//   'Noun': new Terminal('Noun'),
//   'the': new Literal('the')
// });

// console.log(generateSentenceStructures(g, 5));